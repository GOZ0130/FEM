...
% function h = uniform(p,a,tx,ty)
%     p_shift1 = pshift(p, -tx-a, -ty-a);
%     p_shift2 = pshift(p, -tx+a, -ty+a);
%     h = min(min(sqrt(sum(p_shift1.^2,2)),sqrt(sum(p_shift2.^2,2))),5);
% end
